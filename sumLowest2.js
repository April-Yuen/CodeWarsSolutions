...
// sum of two lowest numbers. numbers will be in array. Only 4 numbers in array. 
//all nums positive
// no floats
///////
//strategy
// use sort method to put the numbers in order.
//use indexes to identify the two lowest numbers and return sum. 
