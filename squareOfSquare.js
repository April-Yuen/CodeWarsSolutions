...
var isSquare = function(n){
    // take in a number
    // number cannot be less than one because it will not a square root. 
    //squareroot is a number that when you multiply it with itself, you get that number. 
    let square = Math.sqrt(n)
    let integer = Number.isInteger(square)
    return integer
  }
